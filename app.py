...
<div class="app-header">
    ...
    <div>
        ...
        <div class="header-sub">Project 10281 · Predict · Analyse · Act · Powered by Baseline Random Forest</div>
    </div>
</div>
""", unsafe_allow_html=True)
...
with tab3:
    ...
    fig_fi = px.bar(importances, orientation="h",
                    title="Top 15 Feature Importances — Baseline Random Forest",
    ...
    factors = [
        ("1", "EmpLastSalaryHikePercent", "#63b3ed",
         "Highest importance feature (0.2147). Employees with ≥20% hike are more likely to be Rating 4."),
        ("2", "EmpEnvironmentSatisfaction", "#48bb78",
         "Highest positive correlation with performance (0.396). Low satisfaction strongly predicts Rating 2."),
    ...
    info_items = {
        ...
        "Estimators":            str(params.get("n_estimators", "100")),
        "Max Depth":             "None (unlimited — default)",
        "Min Samples Split":     str(params.get("min_samples_split", "2")),
